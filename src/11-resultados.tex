...
\begin{landscape}
	...
	\begin{figure}[htbp]
		...
		\includegraphics[width=\linewidth]{resultados/flujoMLOps.png}
...
\includegraphics[width=0.5\textwidth]{resultados/estructuraCarModNote.png}
\caption*{\footnotesize Fuente: Elaboración propia}
...
\includegraphics[width=0.8\textwidth]{resultados/configuracionesMain.png}
\caption*{\footnotesize Fuente: Elaboración propia}
...
\includegraphics[width=0.7\textwidth]{resultados/estructuraArchivoRaw.png}
\caption*{\footnotesize Fuente: Elaboración propia}
...
\includegraphics[width=0.9\textwidth]{resultados/estadoDatos1.png}
\caption*{\footnotesize Fuente: Elaboración propia}
...
\includegraphics[width=0.25\textwidth]{resultados/estructuraCarpetaAPI.png}
\caption*{\footnotesize Fuente: Elaboración propia}
...
\includegraphics[width=0.3\textwidth]{resultados/estructuraCarpetaApp.png}
\caption*{\footnotesize Fuente: Elaboración propia}
